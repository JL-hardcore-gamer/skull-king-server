...
describe('findHighestCardOwner()', () => {
  ...
  it('The highest blue card is player 2 (12 Blue)', () => {
...
describe('computeTrickPlayerOrder()', () => {
  ...
  it('At first trick of a round', () => {
    const trickPlayerOrder1 = new ArraySchema<number>();
  ...
  it('During the round', () => {
    round.firstPlayer = 5;
    const trickPlayerOrder2 = new ArraySchema<number>();
...
describe('findFirstCardOwner()', () => {
  ...
  it('Find first pirate played, with Bloody Mary', () => {
  ...
  it('Find first pirate played, with Bloody Mary as a winner', () => {
...
describe('computeWinner()', () => {
  it('Black wins over suit cards (Mary as an Escape)', () => {
    const trick = setupTrick();
    const result = { winner: 1, skullKingCaptured: 0, piratesCaptured: 0 };

    expect(computeWinner(trick)).toStrictEqual(result);
  });

  it('Pirates win over Black cards and Mermaids', () => {
    const cardsId = [53, 58, 54, 57, 41, 65];
    // sirène, pirate, sirène, pirate, 3 noir, bloody Mary
  ...
  it('Mermaids win over black cards', () => {
  ...
  it('Mermaids win over the Skull King (and SK counter is incremented)', () => {
  ...
  it('Mermaids win over the Skull King even with pirates', () => {
  ...
  it('Skull King captures pirates', () => {
  ...
  it('Skull King captures bloody Mary (escape)', () => {
  ...
  it('Skull King captures bloody Mary (pirate)', () => {
    const cardsId = [52, 16, 65, 51, 41, 13];
    //  skull king, 4 bleu, bloody Mary, 13 noir, 3 noir, 1 bleu
  ...
  it('Flags only: winner is the first player', () => {
  ...
  it('Suit color wins over higher cards of other suits (except black)', () => {
